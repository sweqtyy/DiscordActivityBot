...
client.on("message", async message => {
    ...
    if (cmd === "catpic") {
        const catpickey = 'bacd081d-3413-41e7-bf87-c26a71dd76d6';
        
      const catpicfinder = await fetch('https://api.thecatapi.com/v1/images/search', { headers: { 'x-api-key': catpickey }});
